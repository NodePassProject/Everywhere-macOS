#!/usr/bin/env ruby
# Wires the EverywhereCore SwiftPM package + yacd-gh-pages resource bundle
...
project.save
puts "Wired EverywhereCore @ #{EVERYWHERE_CORE_VERSION} (SwiftPM) + yacd-gh-pages into #{PROJECT_PATH}"
